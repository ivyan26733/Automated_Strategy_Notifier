const { db, daysAgo, getObsContext, getExcluded, fetchCmp, send, sendErr, must, BRK_WINDOW_DAYS } = require('./_utils')
...
module.exports = async (req, res) => {
  try {
    ...
    const { data } = must(await db.from('signals')
      ...
      .order('breakout_pct', { ascending: false }), 'signals breakouts')
